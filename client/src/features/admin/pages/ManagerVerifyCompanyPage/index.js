...
import styles from "./ManagerVerifyCompanyPage.module.scss";
...
function ManagerVerifyCompanyPage(props) {
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await request.get("admin/user/companyauth");
        if (res.status === 200) {
...
export default ManagerVerifyCompanyPage;
